...
namespace Achievability
{
    class Program
	{
        static void Main(string[] args) {
			...
			var T16 = new Goal("T16", GoalTypes.TASK, DecompositionTypes.LEAF, new List<Goal>(), new List<WorldContext>() { new AbiltyToMoveContext(DecompositionTypes.AND, false) });
			var T17 = new Goal("T17", GoalTypes.TASK, DecompositionTypes.LEAF, new List<Goal>(), new List<WorldContext>() { new AbiltyToMoveContext(DecompositionTypes.OR, false), new HomeAssistanceContext(DecompositionTypes.OR), new TecnologyAversionContext(DecompositionTypes.OR) });
			var T18 = new Goal("T18", GoalTypes.TASK, DecompositionTypes.LEAF, new List<Goal>(), new List<WorldContext>() { new AbiltyToMoveContext(DecompositionTypes.OR, false), new TecnologyAversionContext(DecompositionTypes.OR, false) });
			var T19 = new Goal("T19", GoalTypes.TASK, DecompositionTypes.LEAF, new List<Goal>(), new List<WorldContext>() { new AbiltyToMoveContext(DecompositionTypes.OR, false), new TecnologyAversionContext(DecompositionTypes.OR, false) });
